    ...
    render() {
        return (
            <div className="general-grid">
              <p>Orden:
                <Button class="btn btn-primary" bsStyle={this.state.ascBut} onClick={this.orderAscendent}>Ascendente</Button>
                <Button class="btn btn-primary" bsStyle={this.state.desBut} onClick={this.orderDescendent}>Descendente</Button>
              </p>
          </div>
        );
  }
